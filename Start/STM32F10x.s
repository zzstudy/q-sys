...
STKVBFAR	EQU 0x1FFFFFFC
ERRSP		EQU 0x1FFFFFE0
...
PutsEnd
	...
	;if(BFSR==0x00000092 && BFAR==0x1FFFFFFC && SP==0x1FFFFFE0),is stack overflow,output deubg msg to uart.
	;else goto HardFaultException
	LDR	 R1,=ERRSP	
	CMP	 R0, R1
	BNE	 HardFaultException ;SP==0x1FFFFFE0

	LDR	 R1,=BFSR
	LDR	 R1,[R1]
	LDR	 R2,=STKVBFSR
	CMP 	 R1,	R2
	BNE	 HardFaultException ;BFSR==0x00000092

	LDR	 R1,=BFAR
	LDR	 R1,[R1]
	LDR	 R2,=STKVBFAR
	CMP 	 R1,	R2
	BNE	 HardFaultException ;BFAR==0x1FFFFFFC
