...
void  OSInit (void)
{
#if OS_CPU_HOOKS_EN > 0 && OS_VERSION > 203 //modify by karlno
...
#else 
		ptcb1->OSTCBTaskName=(void *)0;//modify by karlno
#endif
        ptcb1++;
        ptcb2++;
    }
...
void  OS_TaskIdle (void *p_arg)
{
    ...
    for (;;) {
        ...
        OSIdleCtr++;
        OS_EXIT_CRITICAL();
#if OS_CPU_HOOKS_EN > 0 && OS_VERSION >= 251 //modify by karlno
...
#if OS_CPU_HOOKS_EN > 0 //modify by karlno
